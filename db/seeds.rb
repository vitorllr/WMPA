...
pet = Pet.create!(name: "Rex", age: 2, breed: "germansheper", kennel: kennel, user_id: user.id, gender: "female", tipo: true, size:"small",charac:"happy")
pet = Pet.create!(name: "dolito", age: 2, breed: "germansheper", kennel: kennel, user_id: user.id, gender: "female", tipo: true, size:"small",charac:"happy")
pet = Pet.create!(name: "happy", age: 2, breed: "germansheper", kennel: kennel, user_id: user.id, gender: "female", tipo: true, size:"small",charac:"happy")
